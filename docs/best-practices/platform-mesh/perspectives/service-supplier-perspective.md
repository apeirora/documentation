...
This service can be anything, as long as it meets one crucial requirement set by Apeiro: the lifecycle of a <Term>capability</Term> of the service must be controllable through Apeiro's declarative model.
...
However, these considerations fall outside the scope of Apeiro.

...
This document lists conference talks on Apeiro and its projects. It contains references to publicly available material such as slides or recordings.

## General Apeiro

Here is an overview on our appearances on general [ApeiroRA](https://apeirora.eu), [Linux Foundation Europe](https://linuxfoundation.eu), [NeoNephos](https://neonephos.org) topics.

### Apeiro and NeoNephos

Apeiro was part of the [SAP Open Source webinar series](https://go4.events.sap.com/ospo-webinar-series/en_us/webinar-replays.html), find the recording here: [Apeiro Reference Architecture – Strengthening Digital Sovereignty for Europe'](https://vods.dm.ux.sap.com/ospo-webinar-series/vods/public-sap-open-source-webinar-may-2025.mp4)
...
Apeiro: Open-Source Toolbox for your own Cloud Infrastructure, [Keynote at the Linux Foundation Europe Member Summit 2024](https://www.youtube.com/watch?v=Xf6odOerX7E).
